...
const welcomeScreen: HTMLElement | null = document.getElementById("welcomeScreen");
...
export function initMenubar(): void {
  ...
  function openItem(item: Element): void {
...
export function updateMenuState(getActiveTab: () => any, hasOpenTabs: () => boolean, getFolderPath: () => string | null | undefined): void {
...
function updatePdfButtonLabel(getActiveTab: () => any): void {
